# Group 2: Cynthia, Tadeo, Sally, Heather.
# Our output is a tibble with 0 objects and the mean does not get calculated. What is going on?
...
#> Error in mean(Temp_in): object 'Temp_in' not found